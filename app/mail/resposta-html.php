...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Lato', Helvetica, Arial, sans-serif; 
        ...
        Estamos muito felizes em tê-lo aqui! Prepare-se para resolver sua(s) dúvida(s). </div>   
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            <p style="margin: 0;">Olá Sr(a) <b><?= Html::encode($res['nm_nom_cid']) ?></b>, 
                                a resposta do sua demanda de Nº - <b><?= Html::encode($res['numEmail']) ?></b>, 
                                enviado na data de <b><?= Html::encode($res['dataEmail']) ?></b>,
                                com o Assunto - <b><?= Html::encode($res['nm_nom_sub']) ?></b>, 
                                está disponível na página da SMHPS.<br>
                                Click no botão abaixo para acessar conteúdo da Resposta da SMHSP.</p>
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                    <a href="https://mcmvc.hab.lan" target="_blank" style="font-size: 20px; 
                                                       ...
                                                       display: inline-block;">Ver resposta</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; 
                            ...
                            <span>&copy; SMHPS - Sec. de Habitação e Politicas Sociais <?= date('Y') ?></span>
                        </td>
                    </tr>
                </table>
            </td>
