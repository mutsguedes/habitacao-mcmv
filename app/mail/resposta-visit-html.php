...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Lato', Helvetica, Arial, sans-serif; 
        ...
        Estamos muito felizes em tê-lo aqui!</div>   
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; 
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2px;">Obrigado!</h1> 
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            <p style="margin: 0;">Olá Sr(a) <b><?= Html::encode($res['nm_nom_cid']) ?></b>!<br> 
                                O seu <b>COMPLEMENTO</b> para sua demanda de Nº - <b><?= Html::encode($res['numEmail']) ?></b>, 
                                postada por vc foi enviado na data de <b><?= Html::encode($res['dataEmail']) ?></b>, com <b>sucesso</b>, e
                                está disponível na página da SMHPS.<br>
                                A SMHPS tem até a data de <b><?= Html::encode($res['dataManif']) ?></b>, para fazer um Complemento novo.<br>
                                Click no botão abaixo para acessar conteúdo do Complemento.</p>
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                    <a href="https://mcmvc.hab.lan" target="_blank" style="font-size: 20px; 
                                                       ...
                                                       display: inline-block;">Ver complemento</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;"><a href="https://mcmvc.hab.lan" target="_blank" style="color: #FFA73B;">https://mcmvc.hab.lan</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            padding: 0px 30px 20px 30px; color: #666666; 
                            font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                            <p style="margin: 0;">Se você tiver alguma dúvida, responda a este e-mail através da nossa página na web. 
                                Estamos sempre felizes em ajudar.</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            <p style="margin: 0;">Atenciosamente,<br>Equipe SMHPS</p>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; 
                            ...
                            <span>&copy; SMHPS - Sec. de Habitação e Políticas Sociais <?= date('Y') ?></span>
                        </td>
                    </tr>
                </table>
            </td>
