                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            <p style="margin: 0;">Olá Sr(a) <b><?= Html::encode($res['nm_nom_cid']) ?></b>, 
                                o seu email  com o Assunto - <b><?= Html::encode($res['nm_nom_sub']) ?></b>,
                                enviado na data de <b><?= Html::encode($res['dataEmail']) ?></b>, gerou um protocolo 
                                de Nº - <b><?= Html::encode($res['numEmail']) ?></b>.<br>
                                A SMHPS tem até a data de <b><?= Html::encode($res['dataManif']) ?></b>, para fazer um Complemento.<br>
                                Para saber o andamento de seu questionamento, click no botão abaixo 
                                para acessar conteúdo na página SMHSP.</p>
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                    <a href="https://mcmvc.hab.lan" target="_blank" style="font-size: 20px; 
                                                       ...
                                                       display: inline-block;">SMHPS</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
