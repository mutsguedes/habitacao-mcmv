                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; 
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2px;">Atenção!</h1> 
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="text-align:justify; text-justify: inter-word;
                            ...
                            <p style="margin: 0;">Olá Sr(a) <b><?= Html::encode($res['nm_nom_cid']) ?></b>!<br>
                                A SMHPS inseriu um <b>COMPLEMENTO</b> para sua demanda de Nº - <b><?= Html::encode($res['numEmail']) ?></b>, 
                                esta foi postada pela SMHPS na data de <b><?= Html::encode($res['dataEmail']) ?></b>, e 
                                está disponível na página da SMHPS.<br>
                                O Sr(a) tem até a data de <b><?= Html::encode($res['dataManif']) ?></b>,
                                para fazer um Complemento novo ou FINALIZAR a sua demanda, 
                                passando esta data, sua demanda será FINALIZADA automaticamente pelo SISTEMA.<br>
