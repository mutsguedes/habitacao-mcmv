...
class DependentesController extends Controller
{
    ...
    public function actionCreate($idRes)
    {
        ...
        try {
            ...
            Yii::$app->session->setFlash(Alert::TYPE_ERROR, [
                [
                    'title' => $resmodel . " Error!",
                    'text' => $resmodel . " exite(m) error(os) no formulário. No(s) campo(s).",
                     'footer'=>$message,
    ...
    public function actionDeleteFake($idDep)
    {
        ...
        //            $this->findModel($idDep)->delete();
        //        };
        return $this->redirect(['lista-dependente-resp', 'idRes' => $isRes]);
