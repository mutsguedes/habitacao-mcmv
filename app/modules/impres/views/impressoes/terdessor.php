...
<body>
    <div class="container-fluid" style="font-family: verdana,geneva; font-size: 16px; padding: 0px 0px 0px 0px">
        ...
        <div class="row" style="font-size: large; text-align: center;  padding: 0px 5px 20px 5px">
            ...
            <p style="font-size: x-large;">Termo de Desistência do Sorteio Minha Casa Minha Vida</p>
        </div>
        <div class="row">
            <div class="col-xs-12" style="text-align: justify; line-height: 2; padding: 0px 50px 50px 50px;">
                <p>
                    ...
                    venho através deste <strong>Termo de Desistência do Sorteio Minha Casa Minha Vida</strong>,
                    expressar minha decisão voluntária de desistir do sorteio deste Programa.
                </p>
                <p>
