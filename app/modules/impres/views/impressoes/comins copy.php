...
<body>
    <div class="container-fluid" style="font-family: verdana,geneva; font-size: 16px; padding: 0px 0px 0px 0px">
        ...
        <div class="row" style="font-size: large; text-align: center;  padding: 0px 5px 30px 5px">
            ...
            if (strtotime($modelR->dt_tim_cri) < strtotime('2022-05-01')) {
            ?>
                <p style="font-size: x-large;">Comprovante de Inscrição do Programa Minha Casa Minha Vida</p>
            <?php
            } else {
            ?>
                <p style="font-size: x-large;">Comprovante de Inscrição do Programa Habitacional da Prefeitura Municipal de Itaboraí</p>
            <?php
            }
            ?>
        ...
        <div class="row">
            <div class="col-xs-12" style="text-align: left;  padding: 0px 0px 30px 5px;">
                Srº(ª) <strong><?= $modelR->nm_nom_res ?></strong>, sua inscrição foi realizada com sucesso.
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12" style="font-size: 16px; text-align: center;  padding: 0px 0px 30px 5px;">
                <strong>Número de inscrição: </strong><?= MarArtHelpers::mascaraString('####.##.##', $modelR->nu_num_ins) . '/' . $modelR->nu_num_seq ?>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12" style="font-size: 12px; text-align: justify; padding: 100px 0px 0px 0px;">
                ...
                <strong><em>Atendimento:</em></strong> segunda-feira à sexta-feira das 8h às 17h<br>
                <strong><em>Endereço:</em></strong> Antônio José Marins, 256 Centro (Antigo Bolsa Família)
            </div>
        </div>
    </div>
    </div>
