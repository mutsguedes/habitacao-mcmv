...
$script = <<< JS
$.ajax({
    url:"get-total-mulher",
        type: "POST",
        data:$(this).serialize(),
        dataType: "json",
        success: function(data) {
        var tmchart = $('#tmulherChar').highcharts();
        tmchart.series[0].setData([['NI-R', parseInt(data['ninformador'],10)],
            ['NI-D', parseInt(data['ninformadod'],10)],
            ['Responsável', parseInt(data['totmulherr'], 10)],
            ['Dependente', parseInt(data['totmulherd'], 10)]], true);
        console.log(data);
        console.log(tmchart.series[0].data[0].options);
