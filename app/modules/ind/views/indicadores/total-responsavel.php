...
$script = <<< JS
$.ajax({
    url:"get-total-responsavel",
        type: "POST",
        data:$(this).serialize(),
        dataType: "json",
        success: function(data) {
        var trchart = $('#tresChar').highcharts();
        trchart.series[0].setData([['NI', parseInt(data['ninformado'],10)],
            ['Feminino', parseInt(data['feminino'],10)],
            ['Masculino', parseInt(data['masculino'],10)]], true);
        console.log(data);
        console.log(trchart.series[0].data[0].options);
