        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="roundedcirclecabicon">
                    <span class="fas fa-wheelchair fa-4x"></span>
                </div>
            </div> <!-- row -->
...
$.ajax({
        ...
        var dchart = $('#defChar').highcharts();
        dchart.series[0].setData([['Auditivo', parseInt(data['auditivo'],10)], 
            ['Fisica',  parseInt(data['fisico'],10)], 
            ['Intelectual',  parseInt(data['intelectual'],10)], 
            ['Auditivo',  parseInt(data['nanismo'],10)], 
            ['Visual',  parseInt(data['visual'],10)],
            ['Multipla',  parseInt(data['multipla'],10)]],true);
        console.log(data);
        console.log(dchart.series[0].data[0].options);
