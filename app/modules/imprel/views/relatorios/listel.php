...
<body>
    <htmlpageheader name="myHeader" style="display:none">
        <table width="100%">
            <tr>
                <td width="28%" height="100%" style="text-align: center; font-size: 18px"><strong>Lista Telefone</strong></td>
        ...
        <table width="100%">
            ...
            foreach ($modelR as $row) {
                ...
                <tr>
                    ...
                    <td width="4%" style="text-align: center; font-size: 12px;">
                        <?php
                        $claUrna = 4;
                ...
                switch ($claUrna) {
                    ...
                    <td width="8%" style="text-align: left; font-size: 12px;">
                        <?=
