$(document).ready(function () {
  ...
  $("#calendar").change(function () {
    ...
    // var urlAllTimePro =
    //"https://api.mcmv.itaborai.rj.gov.br/web/agendas/get-all-day-time";

    var urlAllTimePro =
      "https://mcmv.itaborai.rj.gov.br/web/api/agendas/get-all-day-time";

    var urlAgeCrePro =
      "https://mcmv.itaborai.rj.gov.br/web/agenda/agendas/create?";
    var urlAgeUpdPro =
      "https://mcmv.itaborai.rj.gov.br/web/agenda/agendas/update?";
    var idAge = $("#idAge").val();
    console.log(idAge);
    var urlAgeCreUpd = (idAge.length == 0) ? urlAgeCrePro : urlAgeUpdPro;
    var col = 1;
    var tot = 1;
    var divCol =
...
function snwNavLinkVacanciesMonth(event) {
  ...
  //urlCountMonthPro =
  //"https://mcmv.itaborai.rj.gov.br/web/agendas/get-counter-month";

  urlCountMonthPro =
    "https://mcmv.itaborai.rj.gov.br/web/api/agendas/get-counter-month";
  urlCountIniPro =
    "https://mcmv.itaborai.rj.gov.br/web/agenda/agendas/index-ini";
  swalWithBootstrapButtons.fire({
...
$("#dt_age_dat").change(function () {
  ...
  if ($(this).val().length === 0) {
    ...
    date = { date: $(this).val() };
    //date = { date: $(this).select2("data")[0].text.substr(0, 10) };
    //urlGetAllTimePro = "https://itaborai.rj.gov.br/web/agendas/get-all-day-time";

    urlGetAllTimePro =
      "https://mcmv.itaborai.rj.gov.br/web/api/agendas/get-all-day-time";
    $("#ti_age_hor").find("option").remove().end();
    $.getJSON(urlGetAllTimePro, date, {
      tagmode: "any",
    })
      .done(function (json) {
        var freeTime = "";
