...
class Valida extends Validator
{
    /*
     ...
     * @return bool
     */
    public static function cc($cc, $flag = Valida::CARD_ALL)
    {
        // Canonicalize input
        ...
        $d = 0;
        for ($sum = 0, $idx = strlen($cc) - 1, $wt = 1; $idx >= 0; $wt = ($wt % 2) + 1, --$idx) {
     ...
     * @return bool
     */
    public static function celular($phone)
    {
     ...
     * @return bool
     */
    public static function tituloEleitoral($te)
    {
    ...
    {
        return preg_match(
            '{^([14689][1-9]|2[14]|[23][278]|[357][13-5]|7[79])$}',
            $ddd
        ) != false;
    }
